...
<?php } ?>
<form name="shipworks_account_form" method="post" action="<?php PLUGIN_PATH_SHIPWORKSWORDPRESS . 'view/control/controlAdmin.php'?>">
...
<form name="shipworks_address_form" method="post" action="<?php PLUGIN_PATH_SHIPWORKSWORDPRESS . 'view/control/controlAdmin.php'?>">
