...
<?php } ?>
<form name="shipworks_account_form" method="post" action="<?php echo PLUGIN_PATH_SHIPWORKSWORDPRESS . 'control/controlAdmin.php'?>">
...
<form name="shipworks_address_form" method="post" action="<?php echo PLUGIN_PATH_SHIPWORKSWORDPRESS . 'control/controlAdmin.php'?>">
